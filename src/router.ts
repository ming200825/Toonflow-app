...
import route81 from "./routes/novel/crawlNovel";
import route82 from "./routes/novel/crawlDirectory";
...
import route80 from "./routes/other/register";
...
import route78 from "./routes/user/changePassword";
import route79 from "./routes/user/resetPassword";
...
export default async (app: Express) => {
  ...
  app.use("/novel/crawlNovel", route81);
  app.use("/novel/crawlDirectory", route82);
  ...
  app.use("/other/register", route80);
  ...
  app.use("/user/changePassword", route78);
  app.use("/user/resetPassword", route79);
